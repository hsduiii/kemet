defmodule KemetWeb.AdminAuthTest do
  use KemetWeb.ConnCase, async: true

  alias Kemet.Accounts
  alias KemetWeb.AdminAuth
  import Kemet.AccountsFixtures

  @remember_me_cookie "_kemet_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KemetWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KemetWeb.Endpoint.subscribe(live_socket_id)
