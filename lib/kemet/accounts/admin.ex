defmodule Kemet.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Kemet.Repo)
  ...
  """
  def valid_password?(%Kemet.Accounts.Admin{hashed_password: hashed_password}, password)
